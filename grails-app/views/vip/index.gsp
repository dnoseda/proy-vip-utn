...
<html lang="es" class="no-js">
	<head>
		...
		<link rel="stylesheet" href="/css/chico-min-0.7.9.css">
	...
	<body>
		...
		<div class="footer mainFooter">
			...
			<p>
				...
				<a target="_blank" href="http://www.mercadolibre.com.ar/seguro_terminos.html">
					Términos y Condiciones
				</a>
				y de las 
				<a target="_blank" href="http://www.mercadolibre.com.ar/org-img/html/MLA/seguro_privacidad.html">
					Políticas de Privacidad
				</a>
				de MercadoLibre Argentina Ltda. 
				<br />
				Copyright © 1999-2011 MercadoLibre Argentina Ltda. 
			</p>
		</div>
		<!-- footer END -->
		<!--/div-->
